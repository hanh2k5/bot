...
- **Cơ chế 3 Đa Luồng:** Bot giả lập cùng lúc 3 thiết bị (Windows, Mac, Linux) để tăng tốc độ cào mà không bị Google chặn.
...
2. Mở file cài đặt lên, **NHÌN XUỐNG GÓC DƯỚI CÙNG VÀ TÍCH VÀO Ô:**
   ☑️ **`Add python.exe to PATH`** _(Rất quan trọng! Quên tích ô này sẽ bị lỗi lệnh)_
